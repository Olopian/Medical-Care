          ...
          <form action="/dashboard/dokter" method="post" class="col-6">
            ...
            <div class="mb-3 col-md">
              ...
              <select class="form-select @error('spesialis') is-invalid @enderror" name="spesialis" id="spesialis">
                ...
                <option value="Spesialis Psikiater">Spesialis Psikiater</option>
                ...
                <option value="Spesialis Gigi & Mulut">Spesialis Gigi & Mulut</option>
                <option value="Spesialis Mata">Spesialis Mata</option>
                <option value="Spesialis Kesehatan Kulit">Spesialis Kesehatan Kulit</option>
